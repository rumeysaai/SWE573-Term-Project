...
class User(AbstractUser):
    ...
    REQUIRED_FIELDS = []      # <--- create_superuser() sırasında zorunlu tutulacak alan kalmadı (email ve şifre zaten zorunlu)
    ...
    guidelines_acknowledged_at = models.DateTimeField(
        null=True, 
        blank=True
    )
    ...
    location = models.CharField(
        ...
        blank=True, 
        null=True, 
        verbose_name="Location (City/District)"
    )
    ...
    skills = models.ManyToManyField(Category, related_name='skill_providers', blank=True, verbose_name="Yetenekler")
    
    # Services I'm Looking For (Heart icon)
    interests = models.ManyToManyField(Category, related_name='interest_seekers', blank=True, verbose_name="İlgi Alanları") 
