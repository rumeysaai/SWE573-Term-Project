...
import { Users, ArrowRightLeft, Tag, Eye, EyeOff, Shield, TrendingUp } from "lucide-react";
...
export default function Admin() {
  ...
  const posts = [
    { id: 1, title: "Story Telling For Kids", author: "storyteller_94", status: "Active", date: "Oct 14, 2025" },
    { id: 2, title: "Web Design Services", author: "designer_can", status: "Active", date: "Oct 13, 2025" },
    { id: 3, title: "Piano Tutoring For Adults", author: "miss_chopin", status: "Active", date: "Oct 12, 2025" },
    { id: 4, title: "Car Repair Assistance", author: "stronghelper", status: "Flagged", date: "Oct 11, 2025" },
  ];

  const transactions = [
    { date: "Oct 14, 2025", from: "storyteller_94", to: "alican_89", hours: 3 },
    { date: "Oct 13, 2025", from: "miss_chopin", to: "merveyilmaz", hours: 1 },
    { date: "Oct 13, 2025", from: "designer_can", to: "stronghelper", hours: 1 },
    { date: "Oct 12, 2025", from: "stronghelper", to: "erensoz", hours: 2 },
    { date: "Oct 11, 2025", from: "rumeysaa", to: "emrahakdeniz", hours: 4 },
  ];
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <Card className="border-primary/20 shadow-md hover:shadow-lg transition-shadow">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 bg-gradient-to-br from-primary/5 to-secondary/20">
            <CardTitle className="text-sm text-primary">Popular Tags</CardTitle>
      ...
      <Card className="border-primary/20 shadow-md">
        <CardHeader className="bg-gradient-to-r from-primary/5 to-secondary/20">
          <CardTitle className="text-primary">Most Popular Tags</CardTitle>
        </CardHeader>
            ...
            <TableBody>
              {posts.map((post) => (
                <TableRow key={post.id} className="border-primary/10 hover:bg-secondary/20">
                  ...
                  <TableCell>
                    <Badge
                      variant={post.status === "Flagged" ? "destructive" : "outline"}
          ...
          <Table>
            ...
            <TableBody>
              {transactions.map((tx, index) => (
                <TableRow key={index} className="border-primary/10 hover:bg-secondary/20">
